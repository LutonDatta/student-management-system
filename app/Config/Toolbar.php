...
class Toolbar extends BaseConfig
{
	...
	*/
	public $collectors = [
		...
		\CodeIgniter\Debug\Toolbar\Collectors\Logs::class,    // Log files can not be created in AE
	...
	|
	*/
	public $maxHistory = 40; // When use AE set it to 0 as no file can be created in GCP AE
