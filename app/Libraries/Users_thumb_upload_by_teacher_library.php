...
class Users_thumb_upload_by_teacher_library{
    ...
    protected function loadAction(){
        ...
        $user = service('StudentsModel')->select('u_thumbnail_id')->find(service('request')->getGet('load_avatar_of'));
    ...
    protected function handleFileUpload($uploaded_file, $name, $size, $error){
        ...
        if( ! is_object($att) ){ 
            ...
            service('StudentsModel')->update(service('request')->getGet('load_avatar_of'),['u_thumbnail_id'=>$this->upload_attachment_id]);
        }
