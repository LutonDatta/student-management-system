...
class Users_thumb_upload_by_teacher_library{
    /**
     * @var array
     */
    protected $options;
    ...
    protected function loadAction(){
        ...
        $user = service('UserStudentsModel')->select('u_thumbnail_id')->find(service('request')->getGet('load_avatar_of'));
    ...
    protected function handleFileUpload($uploaded_file, $name, $size, $error){
        ...
        if( ! is_object($att) ){ 
            ...
            service('UserStudentsModel')->update(service('request')->getGet('load_avatar_of'),['u_thumbnail_id'=>$this->upload_attachment_id]);
        }
