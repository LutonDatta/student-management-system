...
class Users_avatar_local_file_storage_library{
    ...
    protected function loadAction(){
        ...
        $user = service('StudentsModel')->select('u_thumbnail_id')->find(service('AuthLibrary')->getLoggedInUserID());
    ...
    protected function handleFileUpload($uploaded_file, $name, $size, $error){
        ...
        if( ! is_object($att) ){ 
            ...
            service('StudentsModel')->update(service('AuthLibrary')->getLoggedInUserID(),['u_thumbnail_id'=>$this->upload_attachment_id]);
        }
